...
function build(program2) {
  return program2.createCommand("build").description("build project").action(() => {
    logger.box("build");
  });
}
...
var create = (program2) => {
  return program2.createCommand("create").description("create project").action(() => __async(null, null, function* () {
    logger.box("create");
    const templateResult = yield (0, import_prompts.default)({
      type: "select",
      name: "template",
      message: "\u8BF7\u9009\u62E9\u6A21\u7248",
      choices: [
        {
          title: import_picocolors.default.yellow("Alime Card"),
          value: "alime-card",
          description: "\u5C0F\u871C\u5361\u7247"
        },
        {
          title: import_picocolors.default.yellow("Service hall Card"),
          value: "sh-card",
          description: "\u670D\u52A1\u5927\u5385\u5361\u7247"
        },
        {
          title: import_picocolors.default.blue("Alime App"),
          value: "alime-app",
          description: "\u57FA\u871C\u5E73\u53F0\u5E94\u7528"
        }
      ]
    ...
    const typeResult = yield (0, import_prompts.default)({
      type: "select",
      name: "type",
      message: "Please select a variant",
      choices: [
        { title: import_picocolors.default.blue("TypeScript + TailwindCSS"), value: "ts" },
        { title: import_picocolors.default.yellow("JavaScript"), value: "js" }
      ]
    });
    logger.log(typeResult);
    const projectResult = yield (0, import_prompts.default)({
      type: "text",
      name: "projectName",
    ...
    logger.log("");
    logger.log(
      "\u{1F680}  Successfully created project " + import_picocolors.default.green(projectResult.projectName)
    );
    logger.log("\u{1F449}  Get started with the following commands:");
    logger.log("");
...
var info = (program2) => {
  return program2.createCommand("info").description("info project").action(() => {
    logger.box((0, import_picocolors2.green)("welcome to card-cli"));
  });
};
